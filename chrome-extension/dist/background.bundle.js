...
var logger = (0,_utils_logger__WEBPACK_IMPORTED_MODULE_0__.createLogger)('Background');
...
function ensureContentScriptInjected(_x) {
  return _ensureContentScriptInjected.apply(this, arguments);
} // Handle context menu clicks
function _ensureContentScriptInjected() {
  _ensureContentScriptInjected = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tabId) {
    var scriptLogger;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          scriptLogger = logger.createSubLogger('ContentScript');
          _context2.prev = 1;
          _context2.next = 4;
        ...
        case 18:
          ...
          scriptLogger.error('Failed to inject content script', _context2.t1);
...
chrome.contextMenus.onClicked.addListener(/*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(info, tab) {
    var menuLogger, isInjected;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          menuLogger = logger.createSubLogger('ContextMenu');
          ...
          // Ensure content script is injected
          _context.next = 5;
          return ensureContentScriptInjected(tab.id);
        case 5:
        ...
        case 10:
          ...
          chrome.tabs.sendMessage(tab.id, {
            ...
            if (response !== null && response !== void 0 && response.success) {
              ...
              var errorMessage = (response === null || response === void 0 ? void 0 : response.error) || 'Failed to process text';
              menuLogger.error('Text processing failed', {
                error: errorMessage
              });
...
function showNotification(title, message) {
  var notifyLogger = logger.createSubLogger('Notification');
  notifyLogger.debug('Showing notification', {
    title: title,
    message: message
  });
  chrome.notifications.create({
    ...
    if (chrome.runtime.lastError) {
      ...
      notifyLogger.success('Notification shown', {
...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  ...
  var msgLogger = logger.createSubLogger('MessageListener');
  msgLogger.debug('Received message from content script', {
    request: request,
    sender: {
      tab: (_sender$tab = sender.tab) === null || _sender$tab === void 0 ? void 0 : _sender$tab.id,
